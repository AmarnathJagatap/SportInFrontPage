       ...
       <div className='grid md:grid-cols-3'>
            <div>   
              <Bounce bottom duration={1500}>     
                  ...
                  <h1 className="absolute text-white text-center sm:text-5xl text-5xl font-SignikaNegative opacity-0 hover:opacity-100  z-20 top-0 left-0 right-0 bottom-0 flex justify-center hover:animate-pulse items-center"></h1>                                    
                  </div>
              </Bounce>
            </div>
