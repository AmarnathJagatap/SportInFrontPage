    ...
    <div name="about"  className='w-full bg-white'>
       <div className='grid md:grid-cols-2'>
            ...
            <Fade left>         
                ...
                <p className="mx-4 text-[#525252] text-justify mt-10 sm:text-lg text-lg font-SignikaNegative relative z-20">Sportin Entertainment Solutions is a leading leisure and entertainment design firm with a proven track record of creating high-quality indoor entertainment facilities, competitive socializing spaces, and visitor attractions across 13 countries. Our innovative designs are backed by a strong understanding of market demographics, project dynamics, and business feasibility, allowing us to create unique and operationally efficient destinations that set themselves apart from the competition. We are committed to meeting the creative and commercial aspirations of our clients and delivering exceptional leisure experiences.
                </p>
