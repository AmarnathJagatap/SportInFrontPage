...
<p className="text-[#525252] text-justify mt-2 mx-4 sm:text-lg text-lg font-SignikaNegative relative z-20">We provide post-launch support, including operations management, revenue analysis, marketing and promotion, and maximizing revenues. Our goal is to ensure that our clients' leisure facilities are not just operational but successful in the long term.</p>
                </Fade>
